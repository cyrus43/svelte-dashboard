# svelte-dashboard
This is an admin dashboard built using svelte and sapper
# Svelte-Admin-dashboard

A dashboard made by using Svelte and Sapper, inspired from Svelte-Admin Dashboard.
...
### Clone
    ...
    git clone git@github.com:Cyrus43/svelte-dashboard.git
